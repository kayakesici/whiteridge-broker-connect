        ...
        <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12">
          <div>
            ...
            <a
              ...
              className="mt-8 flex items-center justify-between rounded-xl border border-[var(--ridge)]/40 bg-[var(--ridge)]/10 px-5 py-4 transition-colors hover:bg-[var(--ridge)]/15"
            >
              <div>
              ...
              <>
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <label className="flex cursor-pointer items-center justify-between gap-3 rounded-md border border-dashed border-border bg-background/50 px-4 py-2.5 text-sm text-muted-foreground transition-colors hover:border-[var(--ridge)]/40">
