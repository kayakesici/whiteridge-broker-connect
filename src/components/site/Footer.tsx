      ...
      <div className="mx-auto max-w-6xl px-6 py-7 md:py-9">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">whiteridge-capital.co.uk</p>
        ...
        <div className="mt-5 border-t border-border pt-4 text-[11px] text-muted-foreground/80">
          ...
          <div className="mt-3 flex flex-col justify-between gap-1 md:flex-row">
